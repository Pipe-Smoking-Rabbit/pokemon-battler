...
const { Rattata, Squirtle, Charmander, Bulbasaur, Flareon, Leafeon, Vaporeon } = require("./monsters")

async function catchPokemon(trainer, beans) {
    ...
    await inquirer
        ...
        for (let i = 0; i < numberOfPokemon; i++) {
            ...
            .prompt([
            {
                ...
                choices: ["Rattata", "Squirtle", "Charmander", "Bulbasaur", "Flareon", "Vaporeon", "Leafeon"],
            },
            ])
            .then((userInput) => {
